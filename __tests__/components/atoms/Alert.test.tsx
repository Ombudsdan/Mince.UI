...
describe("Alert — variant colour classes", () => {
  it("applies warning amber classes by default", () => {
    ...
    expect(screen.getByRole("alert")).toHaveClass("bg-amber-50", "border-amber-300", "text-amber-800");
  });
  ...
  it("applies success green classes for variant='success'", () => {
    ...
    expect(screen.getByRole("alert")).toHaveClass("bg-green-50", "border-green-300", "text-green-800");
  });
});
