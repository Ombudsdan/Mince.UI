...
describe("SmallSelect — rendering", () => {
  it("renders a <select> element", () => {
    render(<SmallSelect value="month" onChange={jest.fn()} options={OPTIONS} ariaLabel="Calendar view mode" />);
  ...
  it("shows the currently selected value", () => {
    render(<SmallSelect value="year" onChange={jest.fn()} options={OPTIONS} ariaLabel="Calendar view mode" />);
...
describe("SmallSelect — interaction", () => {
  it("calls onChange with the new value when selection changes", async () => {
    ...
    render(<SmallSelect value="month" onChange={handleChange} options={OPTIONS} ariaLabel="Calendar view mode" />);
...
describe("SmallSelect — styling", () => {
  ...
  it("merges an additional className", () => {
    render(<SmallSelect value="month" onChange={jest.fn()} options={OPTIONS} ariaLabel="Label" className="ml-2" />);
