...
describe("AuthCard — rendering", () => {
  ...
  it("renders children inside the card", () => {
    render(<AuthCard title="Sign In"><button>Sign In</button></AuthCard>);
    expect(screen.getByRole("button", { name: "Sign In" })).toBeInTheDocument();
  });

  it("renders the gradient background container", () => {
    const { container } = render(<AuthCard title="Test"><p>content</p></AuthCard>);
...
describe("AuthCard — subtitle", () => {
  it("renders the subtitle when provided", () => {
    render(<AuthCard title="Sign In" subtitle="Sign in to manage your leave"><p>form</p></AuthCard>);
    expect(screen.getByText("Sign in to manage your leave")).toBeInTheDocument();
  });

  it("does not render a subtitle element when omitted", () => {
    const { container } = render(<AuthCard title="Sign In"><p>form</p></AuthCard>);
...
describe("AuthCard — footer", () => {
  it("renders footer content when provided", () => {
    render(<AuthCard title="Sign In" footer={<a href="/register">Register</a>}><p>form</p></AuthCard>);
